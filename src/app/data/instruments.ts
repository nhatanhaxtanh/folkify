...
export const instruments: Instrument[] = [
  ...
  },
  {
    id: "trong",
    name: "Trống",
    englishName: "Trong (Drum)",
    region: "Toàn quốc",
    category: "Gõ",
    emoji: "🥁",
    color: "#92400E",
    bgGradient: "from-orange-700 to-amber-900",
    image: "https://images.unsplash.com/photo-1762951046421-a8a6a26c5ced?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBc2lhbiUyMGRydW0lMjBwZXJjdXNzaW9uJTIwaW5zdHJ1bWVudHxlbnwxfHx8fDE3NzI3ODczMTV8MA&ixlib=rb-4.1.0&q=80&w=1080",
    shortDesc: "Trống là xương sống nhịp điệu của âm nhạc dân tộc",
    description:
      "Trống là họ nhạc cụ gõ đa dạng nhất trong âm nhạc dân tộc Việt Nam. Từ trống cái lớn trong lễ hội đến trống con nhỏ trong hát tuồng, mỗi loại trống mang một vai trò và âm sắc riêng biệt.",
    origin: "Từ thời Hùng Vương (hàng nghìn năm TCN)",
    material: "Gỗ, da trâu hoặc da bò",
    soundRange: "Nhịp điệu (không có cao độ cố định)",
    difficulty: 2,
    popularity: 5,
    lessons: [
      {
        id: "tr-1",
        title: "Nhịp cơ bản 4/4",
        duration: "15 phút",
        level: "Beginner",
        completed: true,
        description: "Học nhịp 4/4 cơ bản trên trống.",
        videoThumb: "https://images.unsplash.com/photo-1762951046421-a8a6a26c5ced?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=200",
        xp: 25,
        steps: [
          "Cầm dùi trống đúng cách",
          "Đánh 4 nhịp đều: 1-2-3-4",
          "Thêm nhịp mạnh vào nhịp 1 và 3",
          "Luyện giữ nhịp ổn định 5 phút",
        ],
        tips: [
          "Đếm thầm khi đánh: 1-2-3-4",
          "Thư giãn cổ tay để âm tự nhiên",
        ],
      },
      {
        id: "tr-2",
        title: "Nhịp chèo truyền thống",
        duration: "25 phút",
        level: "Intermediate",
        completed: false,
        description: "Học nhịp đặc trưng trong hát chèo Bắc Bộ.",
        videoThumb: "https://images.unsplash.com/photo-1759156240671-c646dc7386f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=200",
        xp: 65,
        steps: [
          "Nghe mẫu nhịp chèo nhiều lần",
          "Luyện pattern 8 nhịp đặc trưng",
          "Kết hợp nhịp mạnh nhẹ đúng chỗ",
          "Đánh theo nhạc chèo thật",
        ],
        tips: ["Nhịp chèo có syncopation, luyện chậm trước"],
      },
    ],
    songs: [
      { title: "Trống hội xuân", artist: "Nhạc lễ", duration: "3:00" },
      { title: "Múa lân", artist: "Âm nhạc lễ hội", duration: "4:15" },
    ],
    facts: [
      "Trống đồng Đông Sơn là báu vật quốc gia",
      "Tiếng trống hội xuân mang lại may mắn đầu năm",
      "Có hơn 20 loại trống khác nhau trong văn hóa Việt",
    ],
  },
];
